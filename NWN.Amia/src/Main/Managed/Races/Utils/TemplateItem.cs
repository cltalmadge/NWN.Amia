...
namespace NWN.Amia.Main.Managed.Races.Utils
{
    public static class TemplateItem
    {
        ...
        public static bool CreatureDoesNotHaveTemplate(uint creature) =>
            GetTemplateItemFromCreature(creature) == NWScript.OBJECT_INVALID;

        private static uint GetTemplateItemFromCreature(uint creature) =>
            NWScript.GetItemPossessedBy(creature, TemplateItemResRef);

        public static void SetStrMod(uint creature, int value) => SetLocalInt(StrModVar, creature, value);

        public static void SetDexMod(uint creature, int value) => SetLocalInt(DexModVar, creature, value);

        public static void SetConMod(uint creature, int value) => SetLocalInt(ConModVar, creature, value);

        public static void SetIntMod(uint creature, int value) => SetLocalInt(IntModVar, creature, value);

        public static void SetWisMod(uint creature, int value) => SetLocalInt(WisModVar, creature, value);

        public static void SetChaMod(uint creature, int value) => SetLocalInt(ChaModVar, creature, value);

        public static void SetSubRace(uint creature, string value) => SetLocalString(SubRaceVar, creature, value);
        ...
        public static bool Initialized(in uint nwnObjectId) =>
            NWScript.GetLocalInt(GetTemplateItemFromCreature(nwnObjectId), InitializedVar) == NWScript.TRUE;
    }
}